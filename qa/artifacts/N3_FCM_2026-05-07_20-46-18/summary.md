...
| Android | 15 (SDK 35) |
| Start | 2026-05-07_20-46-18 |
| End | 2026-05-07_20-47-05 |
| Duration | 47s |
...
| Classification | **REAL_FCM_WAKE_FAIL** |
| Delivery latency | 1478ms |
| Wake latency | 0ms |
| Fullscreen latency | 0ms |
| Poll count | 10 |
| Poll interval | 500ms |
| Timeout | 25s |
| FCM message ID | projects/wawapp-952d6/messages/0:1778172393726362%ea809995f9fd7ecd |
...
| FORCE_STOP | 3.4s |
| SEND_PAYLOAD | 1.6s |
| WAIT_FOR_ACTIVITY | 26.1s |
| WAIT_FOR_NOTIFICATION | 2.2s |
