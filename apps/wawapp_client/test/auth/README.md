...
flutter test apps/wawapp_client/test/auth/
...
```bash
flutter test apps/wawapp_client/test/auth/auth_notifier_test.dart
```

### Run with coverage
```bash
flutter test --coverage apps/wawapp_client/test/auth/
```

### Run in watch mode (if using a test runner)
```bash
flutter test --watch apps/wawapp_client/test/auth/
```
