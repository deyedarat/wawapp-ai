...
class NotificationLogger {
  ...
  Future<void> log({
    ...
    debugPrint('[NotificationLogger] log() called — uid=$uid, event=$eventType, type=$notificationType, state=$appState');
    if (uid == null) {
    ...
    try {
      ...
      debugPrint('[NotificationLogger] ✅ Written to notification_logs/$uid/events');
    } on Object catch (e) {
